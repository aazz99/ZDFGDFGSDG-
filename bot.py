				...
				if msg["type"]=="Text" and not msg.get("message_id") in answered:
					if not sleeped:
						if hasAds(msg.get("text")) and not msg.get("author_object_guid") in admins :
							...
							try:
								bot.sendMessage(target,'پشت کن تا بگم🤞🏽' ,message_id=msg.get("message_id"))
							except:
								print("err asll")
							...
							try:
								bot.sendMessage(target, "دوس داری بگم شاهرخ بده بت😖", message_id=msg.get("message_id"))
							except:
								print("err hijhdah")
						...
						elif msg.get("text").startswith("شاهرخ") or msg.get("text").startswith("ابوالفضل"):
							try:
						...
						elif msg.get("text").startswith("شاهی") or msg.get("text").startswith("ابول"):
							try:
								bot.sendMessage(target, "یا مثل ادم بگو شاهرخ یا بگو ابوالفضل", message_id=msg.get("message_id"))
							except:
								print("err chelhaf")
							...
							try:
								bot.sendMessage(target, "منم چیز کلفت میخام😐", message_id=msg.get("message_id"))
							except:
								print("err phash")
							...
							try:
								bot.sendMessage(target, "رفتن زیر اب همو ....😐", message_id=msg.get("message_id"))
							except:
								print("err shas")
							...
							try:
								bot.sendMessage(target, "ربات شاهرخ جون", message_id=msg.get("message_id"))
							except:
								print("err hafch")
                                
						elif msg.get("text").startswith("سازندت کیه") or msg.get("text").startswith("سازنده"):
							try:
								bot.sendMessage(target, "پدرت(شاهرخ)", message_id=msg.get("message_id"))
							except:
								print("err hafpang")
                                
						elif msg.get("text").startswith("جنده") or msg.get("text").startswith("جنده"):
							try:
								bot.sendMessage(target, "جنده عمته دیوث😏گوربه مظلومم دروغ نگو عمت جندس😐", message_id=msg.get("message_id"))
							except:
								print("err hafhash")
						...
						elif msg.get("text").startswith("ممد") or msg.get("text").startswith("ممد"):
							try:
								bot.sendMessage(target, "تنها موجودی ک هیچ وقت تموم نمیشه ممده😐اصلا هر جا دست دراز کنی یه ممد میفته تو دستت🙂😂🫂 ", message_id=msg.get("message_id"))
							except:
								print("err hastad")
                                
						elif msg.get("text").startswith("ربات") or msg.get("text").startswith("بوس"):
							try:
								bot.sendMessage(target, "گمشو شماره نمیدم😐", message_id=msg.get("message_id"))
							except:
								print("err hsyek")
							...
							try:
								bot.sendMessage(target, "از مدیر گپ بگیر @TEXCODER", message_id=msg.get("message_id"))
							except:
								print("err hshch")
						...
						elif msg.get("text").startswith("ابل") or msg.get("text").startswith("ابلی"):
							try:
